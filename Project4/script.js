...
toggleModal("loginRecruiterBtn", "loginModal", "#closeLoginRecruiter, #cancelLoginRecruiter");

toggleModal("signupBtn", "signupModal", "#closeSignupRecruiter, #cancelSignupRecruiter");